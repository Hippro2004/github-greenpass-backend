...
public class GreenpassApplication {
	...
	// return args -> {
	// try {
	// jdbcTemplate.execute("ALTER TABLE reward MODIFY COLUMN reward_details
	// TEXT;");
	...
	// System.out.println("✅ Automatically updated reward table columns to
	// TEXT/LONGTEXT!");
	// } catch (Exception e) {
	// System.err.println("⚠️ Could not alter reward table: " + e.getMessage());
	// }
	// try {
	// jdbcTemplate.execute("ALTER TABLE announcement MODIFY COLUMN description
	// TEXT;");
	// jdbcTemplate.execute("ALTER TABLE announcement MODIFY COLUMN
	// announcement_title TEXT;");
	// jdbcTemplate.execute("ALTER TABLE announcement MODIFY COLUMN image
	// LONGTEXT;");
	// System.out.println("✅ Automatically updated announcement table columns to
	// TEXT/LONGTEXT!");
	// } catch (Exception e) {
	// System.err.println("⚠️ Could not alter announcement table: " +
	// e.getMessage());
	// }
	// try {
